...
Timeline.prototype.applyValues = function() {
  for(var i=0; i<this.anims.length; i++) {
    ...
    var dt = (propertyAnim.endTime - propertyAnim.startTime);
    var t = (dt > 0) ? (this.time - propertyAnim.startTime)/dt : 1;
...
Anim.prototype.to = function() {
  ...
  for(var propertyName in properties) {
    ...
    this.propAnims.push(propAnim);
		this.timeline.anims.push(propAnim);
	}
